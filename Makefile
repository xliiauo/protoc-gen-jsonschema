...
samples:
	...
	@mkdir -p jsonschemas
	@PATH=.:$$PATH; for PROTO_FILE in `ls testdata/proto/*.proto`; do protoc --jsonschema_out=all_fields_required,disallow_additional_properties:jsonschemas --proto_path=testdata/proto $$PROTO_FILE; done
